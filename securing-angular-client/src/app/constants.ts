...
export class Constants {
	...
	public static stsAuthority = 'http://localhost:4242/'; // The Identity provider project app URL. Can be seen in Project properties -> Debug
	...
	// My Test API
	// public static apiRoot = 'https://localhost:44376/messages';
}
