    ...
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                //app.UseDatabaseErrorPage(); Removed this 'cause it was not being seen in the corresponding using module. I.e. IApplicationbuilder was said to not have such method.
            }
            else
            {
